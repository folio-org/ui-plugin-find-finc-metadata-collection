...
<img alt="EFRE-Lod logo" src="https://github.com/folio-org/ui-plugin-find-finc-metadata-collection/blob/master/EFRE_2015_quer_RGB_klein.jpg" width="500" >
...
Run the following from the ui-plugin-find-finc-metadata-collection directory to serve your new app using a development server:
```
stripes serve
```
